...
public class level_01_pillagerModel extends GeoModel<level_01_pillagerEntity> {
    @Override
    public ResourceLocation getModelResource(level_01_pillagerEntity animatable) {
        return new ResourceLocation(pinchbus_alive_illagers.MODID, "geo/level_01_pillager.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(level_01_pillagerEntity animatable) {
        return new ResourceLocation(pinchbus_alive_illagers.MODID, "textures/entity/texture_illager_01.png");
    }

    @Override
    public ResourceLocation getAnimationResource(level_01_pillagerEntity animatable) {
        return new ResourceLocation(pinchbus_alive_illagers.MODID, "animations/illager_01.animation.json");
    }
    @Override
